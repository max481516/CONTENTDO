...
export const siteMetadata: Metadata = {
  // Basic metadata
  title: {
    default: "CONTENTDO — Видеопродакшн в Москве: каскадеры, трюки",
    template: "%s | CONTENTDO",
  },

  description:
    "Полный цикл видеопродакшна: реклама и клипы, экшн-сцены, постановка трюков и каскадеры. Сценарий, съёмка, монтаж, графика и звук — под ключ.",
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: "CONTENTDO",
    title: "CONTENTDO — Видеопродакшн в Москве: каскадеры, трюки",
    description:
      "Полный цикл видеопродакшна: реклама и клипы, экшн-сцены, постановка трюков и каскадеры. Сценарий, съёмка, монтаж, графика и звук — под ключ.",
    images: [
      {
